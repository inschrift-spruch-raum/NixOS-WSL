...
sudo nix-shell --extra-experimental-features "nix-command flakes" -p git --option substituters "https://mirrors.tuna.tsinghua.edu.cn/nix-channels/store" --run "bash $ScriptDir/WSLMake.sh"
